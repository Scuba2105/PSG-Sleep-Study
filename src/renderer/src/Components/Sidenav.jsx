...
export function Sidenav({menuOption, setMenuOption}) {
  return (
    <nav className='main-menu size-100'>
      ...
      <div className={menuOption === "Lessons" ? "menu-option-container-selected flex-c" : "menu-option-container flex-c"} onClick={(e) => setOptionSelected(e, setMenuOption)}>
        <Classes color="#F7F7F7"/>
        <h4 className='menu-heading'>Lessons</h4>
      </div>
      <div className={menuOption === "Certificates" ? "menu-option-container-selected flex-c" : "menu-option-container flex-c"} onClick={(e) => setOptionSelected(e, setMenuOption)}>
